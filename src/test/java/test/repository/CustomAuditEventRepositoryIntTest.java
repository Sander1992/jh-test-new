...
import test.TestApp;
import test.config.Constants;
import test.config.audit.AuditEventConverter;
import test.domain.PersistentAuditEvent;
...
import static test.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
